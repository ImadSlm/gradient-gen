        ...
        >
            ...
            >
                <div className="flex items-center mb-5">
                    ...
                    <button
                        onClick={closeModal}
                        className="ml-3 mr-2 text-sm bg-red-600 text-white hover:bg-red-700 py-1 px-3 rounded"
                    >
                        Close
                    </button>
                </div>
                <p className="rounded font-mono bg-gray-900 p-5 text-gray-200 font-semibold ">{`background-image : ${getGradientCSSValue(
                    gradientValues
                )}`}</p>
            </div>
        </div>
